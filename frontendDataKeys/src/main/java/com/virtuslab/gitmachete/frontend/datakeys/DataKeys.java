...
public final class DataKeys {
  ...
  public static final DataKey<@Nullable IBranchLayoutManager> KEY_BRANCH_LAYOUT_MANAGER = DataKey.create("BRANCH_LAYOUT_MANAGER");
  public static final DataKey<@Nullable IGitMacheteRepository> KEY_GIT_MACHETE_REPOSITORY = DataKey.create("GIT_MACHETE_REPOSITORY");
