...
The latest plugin version is available for IDE versions from 2022.2 onwards. <br/>
...
To install this plugin go to `File > Settings > Plugins` (`Preferences/Settings > Plugins` on macOS) in your IDE,
