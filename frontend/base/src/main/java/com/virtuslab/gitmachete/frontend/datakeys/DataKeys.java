...
public final class DataKeys {
  ...
  public static final DataKey<Object> GIT_MACHETE_REPOSITORY_SNAPSHOT = DataKey
      .create("GIT_MACHETE_REPOSITORY_SNAPSHOT");
  public static final DataKey<String> SELECTED_BRANCH_NAME = DataKey.create("SELECTED_BRANCH_NAME");
  public static final DataKey<String> UNMANAGED_BRANCH_NAME = DataKey.create("UNMANAGED_BRANCH_NAME");
