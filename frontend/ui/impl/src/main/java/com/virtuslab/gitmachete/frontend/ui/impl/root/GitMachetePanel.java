  ...
  public GitMachetePanel(Project project) {
    ...
    addAncestorListener(new AncestorListenerAdapter() {
      ...
      public void ancestorAdded(AncestorEvent event) {
        final var gitRepository = selectedGitRepositoryProvider.getSelectedGitRepository();
        if (gitRepository != null) {
          ...
          final var rediscoverSuggester = new RediscoverSuggester(gitRepository, queueDiscoverOperation);
