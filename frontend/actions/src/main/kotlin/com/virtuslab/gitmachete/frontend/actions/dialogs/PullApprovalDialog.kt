...
class PullApprovalDialog : DoNotAskOption.Adapter() {

  override fun rememberChoice(isSelected: Boolean, exitCode: Int) {
    if (exitCode == Messages.OK && isSelected) {
      PropertiesComponent.getInstance().setValue(TraverseRepositoryAction.SHOW_PULL_APPROVAL, false, /* defaultValue */ true)
    }
  }
