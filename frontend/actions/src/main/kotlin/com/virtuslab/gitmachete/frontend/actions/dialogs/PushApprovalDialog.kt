...
class PushApprovalDialog(val project: Project) : DoNotAskOption.Adapter() {

  override fun rememberChoice(isSelected: Boolean, exitCode: Int) {
    if (exitCode == Messages.OK && isSelected) {
      PropertiesComponent.getInstance(project).setValue(TraverseAction.SHOW_PUSH_APPROVAL, false, /* defaultValue */ true)
    }
  }
