...
class TraverseApprovalDialog : DoNotAskOption.Adapter() {

  override fun rememberChoice(isSelected: Boolean, exitCode: Int) {
    if (exitCode == Messages.OK && isSelected) {
      PropertiesComponent.getInstance().setValue(TraverseRepositoryAction.SHOW_TRAVERSE_APPROVAL, false, /* defaultValue */ true)
    }
  }
