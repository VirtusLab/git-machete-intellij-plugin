...
public interface IExpectsKeyGitMacheteRepository extends IWithLogger {
  default @Nullable IGitMacheteRepositorySnapshot getGitMacheteRepositorySnapshot(@Nullable AnActionEvent anActionEvent) {
  ...
  default @Nullable IBranchLayout getBranchLayout(AnActionEvent anActionEvent) {
    IGitMacheteRepositorySnapshot repoSnapshot = getGitMacheteRepositorySnapshot(anActionEvent);
    IBranchLayout branchLayout = repoSnapshot != null ? repoSnapshot.getBranchLayout() : null;
  ...
  default @Nullable IManagedBranchSnapshot getCurrentMacheteBranchIfManaged(@Nullable AnActionEvent anActionEvent) {
    IGitMacheteRepositorySnapshot repoSnapshot = getGitMacheteRepositorySnapshot(anActionEvent);
