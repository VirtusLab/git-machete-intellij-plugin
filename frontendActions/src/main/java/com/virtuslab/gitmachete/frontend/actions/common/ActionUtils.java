...
public final class ActionUtils {
  ...
  public static final NotificationGroup GIT_MACHETE_NOTIFICATION_GROUP = new NotificationGroup("Git machete notifications",
      NotificationDisplayType.STICKY_BALLOON, /* isLogByDefault */false);
