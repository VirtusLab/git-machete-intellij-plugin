            ...
            method.getCallsFromSelf().forEach(call -> {
              ...
              if (callTargetPackageName.startsWith("git4idea")) {
                String[] whitelistedMethodFullNames = {
                    ...
                    "git4idea.commands.Git.getInstance()",
                    "git4idea.commands.Git.runCommand(git4idea.commands.GitLineHandler)",
                    "git4idea.commands.GitCommandResult.getOutputOrThrow([I)",
                    "git4idea.commands.GitLineHandler.<init>(com.intellij.openapi.project.Project, com.intellij.openapi.vfs.VirtualFile, git4idea.commands.GitCommand)",
                    "git4idea.commands.GitLineHandler.addParameters([Ljava.lang.String;)",
