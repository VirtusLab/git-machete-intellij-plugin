...
public class UIThreadUnsafeMethodInvocationsTestSuite extends BaseArchUnitTestSuite {
  ...
  private static final String[] uiThreadSafeCodeUnitsInUnsafePackages = {
      "git4idea.GitLocalBranch.<init>(java.lang.String)",
      ...
      "git4idea.branch.GitBrancher.merge(git4idea.GitReference, git4idea.branch.GitBrancher$DeleteOnMergeOption, java.util.List)",
      ...
      "git4idea.remote.hosting.GitRemoteBranchesUtil.checkoutRemoteBranch(com.intellij.openapi.project.Project, java.util.List, java.lang.String)",
      ...
      "org.eclipse.jgit.lib.PersonIdent.getWhenAsInstant()",
