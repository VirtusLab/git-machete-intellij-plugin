...
They can also be based on other PR branches as GitHub automatically handles pull request retargeting ([GitHub blogpost](https://github.blog/changelog/2020-05-19-pull-request-retargeting/)).<br/>
