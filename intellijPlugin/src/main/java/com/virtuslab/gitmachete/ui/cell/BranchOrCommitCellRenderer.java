...
public class BranchOrCommitCellRenderer extends TypeSafeTableCellRenderer<BranchOrCommitCell> {
  ...
  private static class MyComponent extends SimpleColoredRenderer {
    ...
    /* TODO (#98): The padding is calculated for all commits in the same branch (and the branch itself).
     * The time consumed could be reduced by using some lazy value, caching, or indent storing.
     */
